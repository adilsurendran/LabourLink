...
const adjustReview = async () => {
    await api.put(
        `/admin/work-adjust-review/${selectedReview._id}`,
        { newRating }
    );
    setShowModal(false);
    fetchReviews();
    ...
    <div className="admin-page-container">
        ...
        <div className="page-header-flex">
            <h1 className="page-title">
                <span>🚩</span> Work Flagged Reviews
            </h1>
        </div>
...
export default AdminWorkFlaggedReviews;
